...
const StudentVisual = props => {
  ...
  function coursearray(courses, coursesChoice) {
            ...
            <div >
...

                {
                  student.courses.length > 0 ? (
                    student.courses.map((course, index) => {
                      ...
                      if ((course.courseName == 'חדו"א  - 1') && (student.courses.find(({ courseName }) => courseName === 'אלגברה לינארית לתוכנה-ה'))) {
                        if (course.grade > 55) {
                          return (
              ...
              <div className="row">
                ...
                {student.courses.length > 0 ? (
                  student.courses.map((course, index) => {
                    var coursesChoice = [];
                    coursearray(student.courses, coursesChoice);
