...
function getBezierPath(_ref) {
  ...
  if (leftAndRight.includes(sourcePosition) && leftAndRight.includes(targetPosition)) {
    ...
    if (hasCurvature) {
      var sourceAndTargetRight = sourcePosition === Position.Right && targetPosition === Position.Right;
      var sourceAndTargetLeft = sourcePosition === Position.Left && targetPosition === Position.Left;
      hx1 = sourceX + amtX;
      hx2 = targetX - amtX;
  ...
  if (hasCurvature) {
    hy1 = sourceY + amtY;
    hy2 = targetY - amtY;
    var sourceAndTargetTop = sourcePosition === Position.Top && targetPosition === Position.Top;
    var sourceAndTargetBottom = sourcePosition === Position.Bottom && targetPosition === Position.Bottom;
...
var ConnectionLine = (function (_ref) {
  ...
  if (connectionLineType === ConnectionLineType.Bezier) {
    ...
    dAttr = getBezierPath(_objectSpread$5(_objectSpread$5({}, pathParams), {}, {
      curvature: 0
    }));
